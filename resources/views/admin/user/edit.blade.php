                    ...
                    {{--<div class="form-group row">
                        ...
                        <div class="col-10">
                            <div class="radio radio-info form-check-inline">
                                <input type="radio" value="1" name="sex" {{ $info->sex == 1 ? 'checked' : '' }}>
                                <label> 男</label>
                            </div>
                            <div class="radio form-check-inline">
                                <input type="radio" value="2" name="sex" {{ $info->sex == 2 ? 'checked' : '' }}>
                                <label> 女</label>
                            </div>
                        </div>
                    </div>--}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <select name="type" id="" class="form-control">
                                <option value="0" {{ $info->type == 0 ? 'selected' : '' }}>学生</option>
                                <option value="1" {{ $info->type == 1 ? 'selected' : '' }}>教职工</option>
                            </select>
                        </div>
                    </div>
                    {{--<div class="form-group row">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            Parsley.on('form:submit', function(e) {
                ...
                return postFormData(formData, '{{ route('user.update', ['id' => $info->code]) }}', 'put', true)
            });
